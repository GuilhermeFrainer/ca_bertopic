...
def test_fed_load_macro_data(temp_raw_dir):
    ...
    df = pl.DataFrame({
        "observation_date": ["2000-01-01", "2000-02-01", "2000-03-01", "2000-04-01", "2000-05-01"],
...
def test_yelp_change_lf():
    ...
    select_cols = [
        "date", "stars", "text", "review_count", "average_stars", 
        "yelping_since", "state", "stars_business", "review_count_business"
    ]
