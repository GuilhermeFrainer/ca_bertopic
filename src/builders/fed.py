...
def load_macro_data(raw_dir: Path, file_name: str, value_col: str, new_name: str) -> pl.DataFrame:
...
def build(raw_dir: Path, interim_dir: Path):
    ...
    gdp_m_df = load_macro_data(raw_dir, "us_gdp_monthly_1999_2026.csv", "GDP_PCH", "gdp_monthly")
    gdp_y_df = load_macro_data(raw_dir, "us_gdp_yearly_1999_2026.csv", "GDP_PC1", "gdp_yearly")
    cpi_m_df = load_macro_data(raw_dir, "cpi_monthly_1999_2026.csv", "CPIAUCSL_PCH", "cpi_monthly")
    cpi_y_df = load_macro_data(raw_dir, "cpi_yearly_1999_2026.csv", "CPIAUCSL_PC1", "cpi_yearly")
    funds_df = load_macro_data(raw_dir, "fed_funds_1999_2026.csv", "FEDFUNDS", "funds_rate")
    unrate_df = load_macro_data(raw_dir, "unemployment_1999_2026.csv", "UNRATE", "unemployment")
